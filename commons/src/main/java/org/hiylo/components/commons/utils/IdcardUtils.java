...
public class IdcardUtils extends StringUtils {
     ...
     * 省、直辖市代码表
     */
    protected static final String[] CITY_CODE = {"11", "12", "13", "14", "15",
     ...
     * 第18位校检码
     */
    protected static final String[] VERIFY_CODE = {"1", "0", "X", "9", "8", "7",
            "6", "5", "4", "3", "2"};
    /**
     * 最低年限
     */
     ...
     * 台湾身份首字母对应数字
     */
    private static Map<String, Integer> twFirstCodes = new HashMap<>();
    /**
     * 香港身份首字母对应数字
     */
    ...
    public static String getGenderByIdCard(String idCard) {
        ...
        String sCardNum = Objects.requireNonNull(idCard).substring(16, 17);
