...
public class ExcelUtils {
    ...
    public static void exportExcel(String title, Map<String, String> headMap, JSONArray jsonArray, String datePattern,
        ...
        try {
            ...
            si.setApplicationName("Ontheway"); // 填加xls文件创建程序信息
            si.setLastAuthor("Ontheway"); // 填加xls文件最后保存者信息
            si.setComments("Ontheway"); // 填加xls文件作者信息
    ...
    public static String exportExcelXToTmpPath(String title, Map<String, String> headMap, JSONArray jsonArray, String datePattern,
                                               int colWidth) throws IOException {
...
//                FileOutputStream("E://b.xlsx");
//        log.debug("正在导出xlsx....");
//        Date
//                d2 = new Date();
//        ExcelUtil.exportExcelX(title, headMap, ja, null, 0,
//                outXlsx);
//        log.debug("共" + count + "条数据,执行" + (new
