...
//        String url = "https://" + domain + urlSuffix;
    ...
    private String request(String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs, boolean useCert, boolean autoReport) throws Exception {
        ...
        IWechatPayDomain.DomainInfo domainInfo = config.getWechatPayDomain().getDomain(config);
        if (domainInfo == null) {
        ...
        try {
            ...
            WechatPayReport.getInstance(config).report(uuid, elapsedTimeMillis, domainInfo.domain, domainInfo.primaryDomain,
    ...
    public String requestWithCert(String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs, boolean autoReport) {
        ...
        if (shouldRetry && Objects.nonNull(this.primaryDomain)) {
